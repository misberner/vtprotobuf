...
func CloneVT_FieldMask(m *fieldmaskpb.FieldMask) *fieldmaskpb.FieldMask {
	if m == nil {
		return (*fieldmaskpb.FieldMask)(nil)
	}
	r := &fieldmaskpb.FieldMask{}
...
func EqualVT_FieldMask(this *fieldmaskpb.FieldMask, that *fieldmaskpb.FieldMask) bool {
	if this == nil {
		return that == nil
	} else if that == nil {
		return false
...
func MarshalVT_FieldMask(m *fieldmaskpb.FieldMask) (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := SizeVT_FieldMask(m)
	dAtA = make([]byte, size)
	n, err := MarshalToSizedBufferVT_FieldMask(m, dAtA[:size])
	if err != nil {
		return nil, err
	}
	return dAtA[:n], nil
...
func MarshalToVT_FieldMask(m *fieldmaskpb.FieldMask, dAtA []byte) (int, error) {
	size := SizeVT_FieldMask(m)
	return MarshalToSizedBufferVT_FieldMask(m, dAtA[:size])
}

func MarshalToSizedBufferVT_FieldMask(m *fieldmaskpb.FieldMask, dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func SizeVT_FieldMask(m *fieldmaskpb.FieldMask) (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func UnmarshalVT_FieldMask(m *fieldmaskpb.FieldMask, dAtA []byte) error {
