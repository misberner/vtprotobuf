...
func CloneVT_Duration(m *durationpb.Duration) *durationpb.Duration {
	if m == nil {
...
func EqualVT_Duration(this *durationpb.Duration, that *durationpb.Duration) bool {
	if this == nil {
		return that == nil
	} else if that == nil {
		return false
...
func MarshalVT_Duration(m *durationpb.Duration) (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := SizeVT_Duration(m)
	dAtA = make([]byte, size)
	n, err := MarshalToSizedBufferVT_Duration(m, dAtA[:size])
	if err != nil {
		return nil, err
	}
	return dAtA[:n], nil
...
func MarshalToVT_Duration(m *durationpb.Duration, dAtA []byte) (int, error) {
	size := SizeVT_Duration(m)
	return MarshalToSizedBufferVT_Duration(m, dAtA[:size])
}

func MarshalToSizedBufferVT_Duration(m *durationpb.Duration, dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func SizeVT_Duration(m *durationpb.Duration) (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func UnmarshalVT_Duration(m *durationpb.Duration, dAtA []byte) error {
