...
func CloneVT_Any(m *anypb.Any) *anypb.Any {
	if m == nil {
...
func EqualVT_Any(this *anypb.Any, that *anypb.Any) bool {
	if this == nil {
		return that == nil
	} else if that == nil {
		return false
...
func MarshalVT_Any(m *anypb.Any) (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := SizeVT_Any(m)
	dAtA = make([]byte, size)
	n, err := MarshalToSizedBufferVT_Any(m, dAtA[:size])
	if err != nil {
		return nil, err
	}
	return dAtA[:n], nil
...
func MarshalToVT_Any(m *anypb.Any, dAtA []byte) (int, error) {
	size := SizeVT_Any(m)
	return MarshalToSizedBufferVT_Any(m, dAtA[:size])
}

func MarshalToSizedBufferVT_Any(m *anypb.Any, dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func SizeVT_Any(m *anypb.Any) (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func UnmarshalVT_Any(m *anypb.Any, dAtA []byte) error {
